...
class BinaryConnection extends BinarySettings
{
...
>>>>>>> 469d5d0c234eb58435d814da480dbca5c867cfaa
            // authorization type to use (currently supported: 'Basic')
            ArangoConnectionOptions::OPTION_AUTH_TYPE => 'Basic',
            // user for basic authorization
            ArangoConnectionOptions::OPTION_AUTH_USER => $this->db_user,
            // password for basic authorization
            ArangoConnectionOptions::OPTION_AUTH_PASSWD => $this->db_user_pass,
...
>>>>>>> 469d5d0c234eb58435d814da480dbca5c867cfaa
    ...
    public static function sons(string $_key, $_tag = "")
    {
        if ($_tag != "") {
